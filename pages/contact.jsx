          ...
          <div className='mx-auto max-w-xl lg:mx-0 lg:max-w-lg'>
            <div className='absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2'>
              ...
              <div
                ...
                aria-hidden='true'>
                <div
                  className='aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#16a34a] to-[#052e16] opacity-20'
                  style={{
                    clipPath:
            ...
            <p className='mt-6 text-xl leading-8 text-gray-300'>Chef Pablo</p>
            <dl className='mt-10 space-y-4 text-base leading-7 text-gray-300'>
              ...
              <div className='flex gap-x-4'>
                ...
                <dd>
                  <a className='hover:text-white' href='tel:+1 (213) 316-6767'>
                    +1 (213) 316-6767
                  </a>
                </dd>
              </div>
